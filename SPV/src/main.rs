...
impl epi::App for Canvas {
    ...
    fn setup(
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------------------
        style.visuals.extreme_bg_color = egui::Color32::from_rgba_premultiplied(
            255,
            255,
            255,
            5,
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------------------
        style.visuals.code_bg_color = egui::Color32::from_rgba_premultiplied(
            100,
            100,
            100,
            255,
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------------------
        style.visuals.hyperlink_color = egui::Color32::from_rgba_premultiplied(
            255,
            0,
            0,
            255,
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------------------
        style.visuals.widgets.noninteractive.bg_fill = egui::Color32::from_rgba_premultiplied(
            100,
            100,
            100,
            255,
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------------------
        style.visuals.widgets.inactive.bg_fill = egui::Color32::from_rgba_premultiplied(
            100,
            100,
            100,
            255,
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------------------
        style.visuals.widgets.active.bg_fill = egui::Color32::from_rgba_premultiplied(
            100,
            100,
            100,
            255,
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------------------
        style.visuals.widgets.open.bg_fill = egui::Color32::from_rgba_premultiplied(
            100,
            100,
            100,
            255,
